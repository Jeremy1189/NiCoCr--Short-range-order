...
function  SRO_set=SRO_cal_NiCo(coords,types,lattice_constant,supersize,nn_th_SRO)
% this function is used to statistic the FCC structure SRO, if you want to
% change to bcc or sc, please change the model
...
coordnate_nn_fcc=[12,6,24,12,24,8];
% coordnate_nn_sc=[6,12,8,6,24,24];
% coordnate_nn_bcc=[8,6,12,24,8,6];
coordinate_num_atoms=coordnate_nn_fcc(nn_th_SRO)*num_total_atoms;
